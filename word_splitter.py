...
def analyze_stress(parts):
            ...
            if i == len(parts3)-1:
                try:
                    if parts3[-3][1] not in bare_vowels:
                        return 'antepenultimate', parts_no_stress
                    elif parts3[-4][1] not in bare_vowels:
                        return 'preantepenultimate', parts_no_stress
                except:
                    return 'wtf', []
                return 'wtf', []
            elif i == len(parts3)-2:
                try:
                    if parts3[-1][1] not in bare_vowels:
                        return 'ultimate', parts_no_stress
    ...
    return 'penultimate', parts_no_stress

def analyze_affixual_adjunct(parts):
    slots = {'type': 'affixual', 1: (parts[0], parts[1])}
    return slots

def analyze_aspectual_adjunct(parts):
    slots = {'type': 'aspectual', 1: parts[0]}
    return slots

def analyze_bias_adjunct(parts):
    slots = {'type': 'bias', 1: parts[0]}
    return slots
